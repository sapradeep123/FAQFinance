...
export function FaqSidebar() {
  const [expandedCategories, setExpandedCategories] = useState<string[]>(['banking'])
  const { activeThreadId, sendMessage, createNewThread } = useChatStore()
  ...
  const handleFaqClick = async (faq: FAQ) => {
    try {
      ...
      // Send the FAQ question and answer to the thread
